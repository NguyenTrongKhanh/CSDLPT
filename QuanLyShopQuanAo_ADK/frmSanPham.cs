...
namespace QuanLyShopQuanAo_ADK
{
    public partial class frmSanPham : Form
    {
        ...
        {
            grvSanPham.AutoGenerateColumns = false;
            ...
            grvSanPham.Columns[4].HeaderText = "Đơn Giá";
            ...
            grvSanPham.Columns[9].HeaderText = "Chi Nhánh";
        ...
        public void DataBinding(DataTable pDataTable)
        {
            ...
            Binding dataBinding9 = new Binding("Text", pDataTable, "MaCN", true, DataSourceUpdateMode.Never);
            txtChiNhanh.DataBindings.Add(dataBinding9);

            txtAnh.DataBindings.Clear();
            Binding dataBinding10 = new Binding("Text", pDataTable, "HinhAnh", true, DataSourceUpdateMode.Never);
            txtAnh.DataBindings.Add(dataBinding10);
        }
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            string strAnh = txtAnh.Text.Trim();
            ...
            if (strAnh == string.Empty)
            {
                MessageBox.Show("Bạn phải nhập " + lblAnh.Text);
                txtAnh.Focus();
                return;
            }
            try
        ...
        private void btnCapNhap_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                { //Cập nhật lại dữ liệu cho dòng vừa tìm được
                    dr["TenSP"] = strTenSP;
                    dr["HinhAnh"] = strAnh;
                    dr["TrangThai"] = strTrangThai;
                    dr["DonGia"] = strDonGia;
                    dr["SoLuongTon"] = strSoLuong;
                    dr["MaChatLieu"] = strChatLieu;
                    dr["MaLoai"] = strLoai;
                    dr["MaNSX"] = strNSX;
                    dr["MaCN"] = strChiNhanh;
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (db.checkExist("dbo.CHITIETHOADON", "MaSP", strMaSP))
                {
